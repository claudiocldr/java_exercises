...
public class Main {
    ...
    public static double exercise1(String text, double expectedScore) {
        ...
        // Setting yourScore to text.length
        yourScore = text.length();
        // ifstatement adding or removing points after checking yourScore
        if (yourScore > 20) {
            yourScore = 20;
        } else {}
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        // Start your code here
        // switch statement checking mealType and performing some operations on yourMealScore
        switch (mealType) {
            case "sandwich":
        ...
        // if statement checking yourMealScore and performing some operation on it
        if (yourMealScore < 5) {
            yourMealScore = 5;
        } else {}
