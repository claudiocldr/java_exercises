...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        // Your code
        // setting a starting price which will be compared to the values in the loop
        double price = 0;
        //loop to compare values of the map
        // and setting the key of the biggest value in the comparison as mostExpensiveMenuItemName
    ...
    private static void exercise3() {
        ...
        // Your code
        // for loop which takes as argument the values of the map and adds them to the variable totalWeight
