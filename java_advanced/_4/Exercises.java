...
public class Exercises {
    ...
    private static void exercise3() {
        ...
        try {
            // Your code here
            // printing the number of lines using split methods to count the occurrences of \n
           int stringLength =  Files.readString(MY_PATH).split("\n").length;
    ...
    private static void exercise4() {
        ...
        try {
            // Your code here
            // printing the length of the array generated by the split method to get the number of words
            System.out.println(Files.readString(MY_PATH).split(" ").length);
            //deleting the file in the specified path
