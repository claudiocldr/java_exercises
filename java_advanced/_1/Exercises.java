...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        // Your code
        // I doppioni vengono ignorati automaticamente
        ourSet.add(1);
        ourSet.add(1);
        ourSet.add(5);
        ourSet.add(2);
...
// questo if statement era sbagliato e l'ho riscritto
    ...
    private static void exercise2() {
        ...
        //apple banana orange kiwi mango because it will ignore duplicates
        ...
        // it will ignore the duplicates and add the non duplicates, in this case grapes and pear
        //apple banana orange kiwi grapes pear mango
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise4() {
        ...
        // Your code
        // I've put a break after just one loop because in the TreeSet, items are ordered alphabetically or in this case
        // numerically so the first loop always gets the min value
