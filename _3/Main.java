...
public class Main {
    ...
    private static void exercise2() {
        ...
        System.out.println("Did I have lunch? True or false? " + true + ".");
        System.out.println("The price of my lunch was " + 8.99 + ".");
    ...
    private static void exercise3() {
        ...
        boolean isLunchDone = true;
        System.out.println("Did I have lunch? True or false? " + isLunchDone + ".");

        double lunchPrice = 8.99;
