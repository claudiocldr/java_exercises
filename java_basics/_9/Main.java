...
// I've put 60 because it was the left condition in the else statement
    ...
    private static void exercise2() {
        ...
        // declared boolean variable which if it's true, it means you can afford lunch
        boolean affordLunch = remainingMoney >= lunchCost;
        // Your if statement here
        // if statement that checks the value of affordLunch and acts accordingly
        if (affordLunch) {
    ...
    private static void exercise3() {
        ...
        // declared boolean variable to check the value of ourDouble
        boolean checkDouble = ourDouble > 2.5;
        // if statement that returns results based on checkDouble boolean value
        if (checkDouble) {
            System.out.println("Greater than");
        } else {
            // adding +1 as the exercise requires
            ourDouble += 1;
            // updating the value of the boolean with our new ourDouble value
            checkDouble = ourDouble > 2.5;
            // another ifstatement that returns result based on the updated checkDouble value
            if (checkDouble) {
    ...
    private static void exercise4() {
        ...
        // start of the ifstatement with initial check >= 65
        if (employeeAge >= 65) {
            System.out.println("Retired");
            // check for experienced worker
            ...
            // since there are only these values left, the else just indicates the school age range
        } else {
