...
public class Main {
    ...
    public static void exercise1() {
        ...
        switch (fastFoodOrder) {
            ...
            case "milkshake":
                ...
                break;
            // Your cases here!
            // adding the two cases cheeseburger and fries below
            case "cheeseburger":
                orderCalories = 850;
                orderCost = 7.99;
                break;
    ...
    public static void exercise2() {
        ...
        switch (inputNumber) {
            case 2, 3, 5, 7, 13, 17:
                System.out.println("This is not the largest prime number under 20");
                break;
            case 19:
    ...
    public static void exercise3Bonus() {
        ...
        int inputNumber = 17;
        switch (inputNumber) {
            case 2, 3, 5, 7, 13, 17 -> System.out.println("This is not the largest prime number under 20");
